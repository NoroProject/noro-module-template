...
impl Module {
    ...
    fn setup(reg: &mut Registration) {
        reg.setting("greet", SettingKind::Toggle, "mod-noro-module-template-greet")
            .default(true)
            .hint("mod-noro-module-template-greet-hint");
    }
    ...
    /// Reachable at `GET /api/modules/noro-module-template/me`.
    ///
